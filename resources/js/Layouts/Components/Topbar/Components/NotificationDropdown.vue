...
<template>
    <div
        class="topbar-item hs-dropdown [--auto-close:inside] relative inline-flex"
    >
        <button
            type="button"
        ...
        >
            ...
            <span
                class="absolute end-0 top-0 size-1.5 bg-primary/90 rounded-full"
            ></span>
        </button>
        <div class="hs-dropdown-menu max-w-100 p-0" role="menu">
            <div class="p-4 border-b border-default-200">
                <div class="flex items-center gap-2">
                    ...
                    <span
                        class="size-5 font-semibold bg-orange-500 rounded text-white flex items-center justify-center text-xs"
                        >15</span
                    >
                </div>
            </div>
            <nav
                class="flex gap-x-1 bg-default-150 p-2 border-b border-default-200"
                aria-label="Tabs"
                role="tablist"
                aria-orientation="horizontal"
            >
                <button
                    data-hs-tab="#tabsViewall"
                    type="button"
                    ...
                    aria-selected="true"
                    aria-controls="tabsViewall"
                    role="tab"
                >
                    View all
                </button>
                <button
                    data-hs-tab="#tabsMentions"
                    type="button"
                    ...
                    aria-selected="false"
                    aria-controls="tabsMentions"
                    role="tab"
                >
                    Mentions
                </button>
                <button
                    data-hs-tab="#tabsFollowers"
                    type="button"
                    class="hs-tab-active:bg-card hs-tab-active:text-primary py-0.5 px-4 rounded font-semibold inline-flex items-center gap-x-2 border-b-2 border-transparent text-xs whitespace-nowrap text-default-500 hover:text-blue-600"
                    aria-selected="false"
                    aria-controls="tabsFollowers"
                    role="tab"
                >
                    Followers
                </button>
                <button
                    data-hs-tab="#tabsInvites"
                    type="button"
                    class="hs-tab-active:bg-card hs-tab-active:text-primary py-0.5 px-4 rounded font-semibold inline-flex items-center gap-x-2 border-b-2 border-transparent text-xs whitespace-nowrap text-default-500 hover:text-blue-600"
                    aria-selected="false"
                    aria-controls="tabsInvites"
                    role="tab"
                >
                    Invites
                </button>
                ...
                >
                    ...
                    >
                        ...
                        <div class="flex justify-between w-full text-sm">
                            <div>
                                ...
                                <p
                                    class="flex items-center gap-1 text-default-500 text-xs"
                                >
                                    <Icon
                                        icon="lucide:clock"
                    ...
                    >
                        ...
                        <div class="flex justify-between w-full">
                            <div class="text-sm">
                                <h6 class="mb-2 font-medium text-default-800">
                                    <b>@caroline_jessica</b> commented <br />on
                                    your post
                                </h6>
                                <p
                                    class="flex items-center gap-1 text-default-500 text-xs"
                                ...
                                <p
                                    class="p-2 bg-default-50 text-default-500 mt-2 rounded"
                                >
                                    Amazing! Fast, to the point, professional
                                    and really amazing to work with them!!!
                                </p>
                            </div>
                            <div>
                                <div
                                ...
                                >
                                    <div>
                                        <div
                                            class="size-1.5 bg-primary rounded-full"
                                        ></div>
                                    </div>
                                    15 min
                                </div>
                    ...
                    >
                        ...
                        <div class="flex justify-between gap-2 w-full">
                            <div>
                                <h6
                                    class="mb-1 font-medium text-default-800 text-sm"
                                >
                    ...
                    >
                        <div class="relative">
                            ...
                            <div
                                class="absolute text-orange-500 bottom-0 -end-0.5 text-base"
                            >
                                <Icon
                                    icon="lucide:heart"
                        ...
                        <div class="flex justify-between w-full">
                            <div>
                                ...
                                <p
                                    class="flex gap-1 items-center text-default-500 text-xs"
                                >
                                    <Icon
                                        icon="lucide:clock"
                                        class="align-middle size-3.5"
                                    ></Icon
                                    ><span>Thursday 06:59 AM</span>
                                </p>
                            </div>
                            <div>
                                <div
            ...
            <div
                class="flex items-center justify-between p-4 border-t border-default-200"
            >
                <Link href="" class="text-sm font-medium text-default-900"
