    ...
    <div class="hs-dropdown-menu max-w-100 p-0" role="menu">
      ...
      <simplebar class="h-80" data-simplebar>
        <div id="tabsViewall" role="tabpanel" aria-labelledby="tabsViewall-item">
          <Link href="" class="flex gap-3 p-4 items-center hover:bg-default-150">
            <div>
              <div class="size-10 rounded-md bg-default-100">
                <img src="../../../../../images/user/avatar-3.png" alt="" class="rounded-md" />
              </div>
            </div>
          ...
          <Link href="" class="flex gap-3 p-4 items-start hover:bg-default-150">
            <div>
              <div class="size-10 rounded-md bg-yellow-100">
                <img src="../../../../../images/user/avatar-5.png" alt="" class="rounded-md" />
              </div>
            </div>
          ...
          <Link href="" class="flex gap-3 p-4 items-center hover:bg-default-150">
            <div class="relative">
              <div class="size-10 rounded-md bg-pink-100">
                <img src="../../../../../images/user/avatar-7.png" alt="" class="rounded-md" />
              </div>
      ...
      <div class="flex items-center justify-between p-4 border-t border-default-200">
        <Link href="" class="text-sm font-medium text-default-900">Manage Notification</Link>
