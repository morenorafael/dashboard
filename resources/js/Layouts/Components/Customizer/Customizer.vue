        ...
        >
            ...
            >
                ...
                <button
                    ...
                    class="btn size-9 rounded-full btn-sm hover:bg-default-150 group"
                    id="fullscreenBtn"
                ...
                <div class="divide-y divide-dashed divide-default-200">
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div
                                class="card-radio"
                                v-for="(item, idx) in sidenavSizes"
                                :key="idx"
                            >
                                <input
                                    class="hidden"
                                ...
                                <div
                                    class="mt-1 text-md font-medium text-center text-default-600"
                                >
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex gap-2">
                            <div
                                v-for="(item, idx) in setPositionOptions"
                                :key="idx"
                            >
                                <input
                                    type="radio"
                                    ...
                                    :id="`dir-${item.dir}`"
                                    :value="item.dir"
                                    :checked="layout.position === item.dir"
                                    @change="() => setPosition(item.dir)"
                                    name="dir"
                                />
                                <label
                                    class="form-label btn bg-default-150"
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex gap-2">
                            <div
                                v-for="(item, idx) in sidenavColorOptions"
                                :key="idx"
                            >
                                <input
                                    ...
                                    :value="item.color"
                                    :checked="
                                        layout.sidenav.color === item.color
                                    "
            ...
            <div class="p-4 flex border-t border-dashed border-default-900/10">
                <div class="flex w-full gap-4">
                    ...
                    <a
                        to="https://1.envato.market/tailwick-tailwind"
                        target="_blank"
                        class="btn bg-primary text-white grow"
                        >Buy Now</a
                    >
                </div>
            </div>
