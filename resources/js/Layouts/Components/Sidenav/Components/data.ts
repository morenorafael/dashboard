        ...
        children: [
            {
                key: "employee",
                label: "Employee List",
                url: "/hr-management/employee",
            },
            {
                key: "holidays",
                label: "Holidays",
                url: "/hr-management/holidays",
            },
            {
                key: "leave-manage",
                label: "Leave Manage",
                ...
                children: [
                    {
                        key: "leave-employee",
                        label: "By Employee",
                        url: "/hr-management/leave-employee",
                    },
                    {
                        key: "add-employee",
                        label: "Add Leave(Employee)",
                        url: "/hr-management/add-employee",
                    },
                    {
                        key: "leave-hr",
                        label: "By HR",
                        url: "/hr-management/leave-hr",
                    },
                    {
                        key: "add-hr",
                        label: "Add Leave(HR)",
                        url: "/hr-management/add-hr",
                    },
                ],
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        url: "/hr-management/attendance-main",
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        key: "estimates",
                        label: "Estimates",
                        url: "/hr-management/estimates",
                    },
                    {
                        key: "payments",
                        label: "Payments",
                        url: "/hr-management/payments",
                    },
                    {
                        key: "expenses",
                        label: "Expenses",
                        url: "/hr-management/expenses",
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        ...
                        url: "/hr-management/employee-salary",
                    },
                    {
                        key: "payslip",
                        label: "Payslip",
                        url: "/hr-management/payslip",
                    },
                    {
                        key: "create-payslip",
                        label: "Create Payslip",
                        url: "/hr-management/create-payslip",
                    },
                ],
            },
        ],
    ...
    },
    {
        ...
        children: [
            ...
            { key: "register", label: "Register", url: "/basic-auth/register" },
            {
                key: "verify-email",
                label: "Verify Email",
                url: "/basic-auth/verify-email",
            },
            {
                key: "two-steps",
                label: "Two Steps",
                url: "/basic-auth/two-steps",
            },
            { key: "logout", label: "Logout", url: "/basic-auth/logout" },
            {
                key: "reset-pass",
                label: "Reset Password",
                url: "/basic-auth/reset-pass",
            },
            {
                key: "create-pass",
                label: "Create Password",
                url: "/basic-auth/create-pass",
            },
        ],
    },
    {
        ...
        children: [
            ...
            { key: "register", label: "Register", url: "/cover-auth/register" },
            {
                key: "verify-email",
                label: "Verify Email",
                url: "/cover-auth/verify-email",
            },
            {
                key: "two-steps",
                label: "Two Steps",
                url: "/cover-auth/two-steps",
            },
            { key: "logout", label: "Logout", url: "/cover-auth/logout" },
            {
                key: "reset-pass",
                label: "Reset Password",
                url: "/cover-auth/reset-pass",
            },
            {
                key: "create-pass",
                label: "Create Password",
                url: "/cover-auth/create-pass",
            },
        ],
    },
    {
        ...
        children: [
            ...
            { key: "register", label: "Register", url: "/boxed-auth/register" },
            {
                key: "verify-email",
                label: "Verify Email",
                url: "/boxed-auth/verify-email",
            },
            {
                key: "two-steps",
                label: "Two Steps",
                url: "/boxed-auth/two-steps",
            },
            { key: "logout", label: "Logout", url: "/boxed-auth/logout" },
            {
                key: "reset-pass",
                label: "Reset Password",
                url: "/boxed-auth/reset-pass",
            },
            {
                key: "create-pass",
                label: "Create Password",
                url: "/boxed-auth/create-pass",
            },
        ],
    },
    {
        ...
        children: [
            { key: "login", label: "Login", url: "/mordern-auth/login" },
            {
                key: "register",
                label: "Register",
                url: "/mordern-auth/register",
            },
            {
                key: "verify-email",
                label: "Verify Email",
                url: "/mordern-auth/verify-email",
            },
            {
                key: "two-steps",
                label: "Two Steps",
                url: "/mordern-auth/two-steps",
            },
            { key: "logout", label: "Logout", url: "/mordern-auth/logout" },
            {
                key: "reset-pass",
                label: "Reset Password",
                url: "/mordern-auth/reset-pass",
            },
            {
                key: "create-pass",
                label: "Create Password",
                url: "/mordern-auth/create-pass",
            },
        ],
    },
    {
        ...
        children: [
            {
                key: "hover-sidenav",
                label: "Hover Sidenav",
                url: "/layout/hover-sidebar",
            },
            {
                key: "hover-active-sideba",
                label: "Hover Active Sidenav",
                url: "/layout/hover-active-sidebar",
            },
            {
                key: "small-sidebar",
                label: "Small Sidenav",
                url: "/layout/small-sidebar",
            },
            {
                key: "compact-sidenav",
                label: "Compact Sidenav",
                url: "/layout/compact-sidebar",
            },
            {
                key: "offcanvas-sidenav",
                label: "Offcanvas Sidenav",
                url: "/layout/offcavas-sidebar",
            },
            {
                key: "hidden-sidenav",
                label: "Hidden Sidenav",
                url: "/layout/hidden-sidebar",
            },
            {
                key: "dark-sidenav",
                label: "Dark Sidenav",
                url: "/layout/dark-sidebar",
            },
