...
export const useLayout = defineStore(
    ...
    () => {
        ...
        const setSideNavColor = (
            nColor: SideNavType["color"],
            persist = true,
        ) => {
            toggleAttribute("data-sidenav-color", nColor);
            if (persist)
                layout.value.sidenav = {
                    ...layout.value.sidenav,
                    color: nColor,
                };
        };
        ...
        const showBackdrop = () => {
            if (!document.getElementById("custom-backdrop")) {
                ...
                backdrop.className =
                    "transition duration fixed inset-0 bg-default-900/50 z-40";
        ...
        const toggleHoverSidebar = () => {
            ...
            const newSize =
                current === "hover-active" ? "hover" : "hover-active";
